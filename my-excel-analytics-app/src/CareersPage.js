...
import { FaFacebook, FaTwitter, FaLinkedin, FaInstagram, FaSun, FaMoon, FaBriefcase, FaUsers, FaHeart, FaChevronRight } from 'react-icons/fa';
    ...
    <div className="bg-gray-900 dark:bg-gray-100 text-gray-100 dark:text-gray-900 font-sans leading-relaxed transition-colors duration-500">
      ...
      <header className="fixed top-0 left-0 w-full z-50 py-4 px-6 md:px-12 flex justify-between items-center bg-gray-800 dark:bg-white bg-opacity-90 dark:bg-opacity-90 backdrop-filter backdrop-blur-lg shadow-lg transition-colors duration-500">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link to="/careers" className="text-gray-300 dark:text-gray-700 hover:text-white dark:hover:text-gray-900 transition-colors duration-300">Careers</Link>
        </nav>
      ...
      <section className="min-h-[60vh] flex items-center bg-cover bg-center pt-20"
        style={{ backgroundImage: `url('https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }}>
      ...
      <section className="py-20 bg-gray-900 dark:bg-white text-center">
        <div className="container mx-auto px-6 max-w-5xl">
          <h2 className="text-4xl font-bold text-white dark:text-gray-900 mb-12">Our Culture & Benefits</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-gray-800 dark:bg-gray-200 p-8 rounded-2xl shadow-xl flex flex-col items-center">
              ...
              <h3 className="text-2xl font-semibold text-white dark:text-gray-900 mb-2">Team Collaboration</h3>
              <p className="text-gray-400 dark:text-gray-600">
                We believe in open communication and working together to solve challenges and build great products.
              </p>
            </div>
            <div className="bg-gray-800 dark:bg-gray-200 p-8 rounded-2xl shadow-xl flex flex-col items-center">
              <FaBriefcase className="text-5xl text-green-400 dark:text-green-600 mb-4" />
              <h3 className="text-2xl font-semibold text-white dark:text-gray-900 mb-2">Growth & Learning</h3>
              <p className="text-gray-400 dark:text-gray-600">
                We invest in our team's professional development with regular training and mentorship programs.
              </p>
            </div>
            <div className="bg-gray-800 dark:bg-gray-200 p-8 rounded-2xl shadow-xl flex flex-col items-center">
              <FaHeart className="text-5xl text-purple-400 dark:text-purple-600 mb-4" />
              <h3 className="text-2xl font-semibold text-white dark:text-gray-900 mb-2">Work-Life Balance</h3>
              <p className="text-gray-400 dark:text-gray-600">
                We offer flexible working hours and a remote-friendly environment to ensure our team is happy and healthy.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-800 dark:bg-gray-200 text-center">
        <div className="container mx-auto px-6 max-w-5xl">
          <h2 className="text-4xl font-bold text-white dark:text-gray-900 mb-12">Current Openings</h2>
          <div className="space-y-6">
            {jobOpenings.map(job => (
              <div key={job.id} className="bg-gray-900 dark:bg-white p-6 rounded-xl shadow-md flex justify-between items-center transition-transform hover:scale-[1.02] duration-300">
                <div className="text-left">
                  <h3 className="text-xl font-semibold text-white dark:text-gray-900">{job.title}</h3>
                  <p className="text-gray-400 dark:text-gray-600 text-sm">
                    {job.department} <span className="mx-2">•</span> {job.location}
                  </p>
                </div>
                <Link to="/apply" className="flex items-center text-blue-400 dark:text-blue-600 font-semibold hover:underline">
