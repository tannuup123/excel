...
const LoginPage = () => {
    ...
    return (
        <div className={`relative flex items-center justify-center min-h-screen transition-colors duration-300 ${ isDarkMode ? "text-white" : "text-gray-800" }`}>
            ...
            <div className="absolute inset-0 bg-cover bg-center bg-fixed z-0" style={{ backgroundImage: `url(${imageUrl})` }}>
            ...
            <div className="relative z-10 w-full max-w-lg p-10 rounded-2xl shadow-2xl text-center border border-white/20 backdrop-filter backdrop-blur-lg bg-white/20 dark:bg-gray-800/20">
                <div className="p-8 rounded-xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* Custom Animated Dropdown for Role Selection (MOVED HERE) */}
            ...
            {showForgotPasswordModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-40">
                    <div className={`p-8 rounded-xl shadow-xl max-w-sm w-full border border-white/20 backdrop-filter backdrop-blur-lg bg-white/20 dark:bg-gray-800/20 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
