  ...
  return (
    <div className="flex h-screen bg-white text-gray-900 dark:bg-gray-900 dark:text-white transition-colors duration-500">
      ...
      <main className="flex-1 p-6 overflow-y-auto">
          ...
          <>
            ...
            <section className="space-y-6">
              ...
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="p-6 bg-white dark:bg-slate-800 rounded-xl shadow-xl"
              >
            ...
            {/* Top Uploaders */}
            <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-slate-800 dark:to-slate-900 rounded-2xl shadow-xl">
        ...
        {activeSection === "profile" && (
          <div className="max-w-lg mx-auto mt-6 p-6 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-slate-800 dark:to-slate-900 rounded-3xl shadow-2xl">
            ...
            {loading ? (
              <div className="animate-pulse space-y-4">
                <div className="w-24 h-24 rounded-full bg-gray-300 dark:bg-gray-600 mx-auto" />
                <div className="h-6 bg-gray-300 dark:bg-gray-600 rounded mx-auto w-3/4" />
                <div className="h-4 bg-gray-300 dark:bg-gray-600 rounded mx-auto w-1/2" />
              </div>
            ) : (
              <>
                {alert.show && (
                ...
                <div className="flex flex-col items-center mb-6">
                  <div className="w-28 h-28 rounded-full bg-blue-500 dark:bg-blue-700 flex items-center justify-center text-4xl font-bold text-white mb-4 shadow-lg">
                    {user.fullname ? user.fullname.charAt(0) : "U"}
                  </div>
                  <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">
                    {user.fullname}
                  </h3>
                  <span className="mt-2 px-4 py-1 rounded-full text-sm font-medium bg-indigo-500 text-white shadow">
