...
const FaqItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-gray-700 dark:border-gray-300 py-4">
      ...
      {isOpen && (
        <p className="mt-2 text-gray-400 dark:text-gray-600 transition-all duration-300">
          {answer}
        </p>
      )}
    </div>
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, you can upgrade or downgrade your plan at any time directly from your dashboard settings.",
    },
    {
      question: "Do you offer a free trial?",
      answer:
        "Yes, we offer a 14-day free trial on our Pro plan with no credit card required. You can sign up and start exploring the features.",
    },
    {
      question: "What is the difference between Starter and Pro?",
      answer:
        "The Starter plan is great for individuals, while the Pro plan offers more advanced features like 3D charts, AI insights, and increased storage for teams.",
    },
    {
      question: "How does billing work?",
      answer:
        "You will be billed monthly or annually, depending on your chosen plan. All payments are processed securely via Stripe or PayPal.",
    },
  ];
      ...
      <section className="py-20 bg-gray-900 dark:bg-gray-100 transition-colors duration-500">
        <div className="container mx-auto px-6 max-w-5xl pt-16 text-center">
          ...
          <p className="text-lg text-gray-400 dark:text-gray-600 max-w-2xl mx-auto">
            Choose the plan that's right for you and get started with a free
            trial on our most popular plan.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900 dark:bg-white p-8 rounded-2xl shadow-lg flex flex-col justify-between">
              <div>
                ...
                <div className="my-6">
                  <span className="text-4xl font-extrabold text-white dark:text-gray-900">
                    $9
                  </span>
                ...
                <ul className="space-y-3 mb-8 text-gray-300 dark:text-gray-700">
                  <li className="flex items-center">
                    <FaCheck className="text-green-400 dark:text-green-600 mr-2" />
                    <span>2D Chart Generation</span>
                  </li>
                  <li className="flex items-center">
                    <FaCheck className="text-green-400 dark:text-green-600 mr-2" />
                    <span>50 Uploads/month</span>
                  </li>
                  <li className="flex items-center">
                    <FaCheck className="text-green-400 dark:text-green-600 mr-2" />
              ...
              <Link
                to="/register"
                className="block text-center w-full bg-blue-500 text-white py-3 rounded-full font-semibold hover:bg-blue-600 transition-colors duration-300"
              >
                Get Started
              </Link>
            </div>
            ...
            <div className="bg-blue-600 text-white p-8 rounded-2xl shadow-xl flex flex-col justify-between transform scale-105">
              <div>
                ...
                <p className="text-gray-200">
                  The best choice for small teams and power users.
                </p>
                <div className="my-6">
              ...
              <Link
                to="/register"
                className="block text-center w-full bg-white text-blue-600 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors duration-300"
              >
            ...
            <div className="bg-gray-900 dark:bg-white p-8 rounded-2xl shadow-lg flex flex-col justify-between">
              ...
              <Link
                to="/contact"
                className="block text-center w-full bg-gray-700 dark:bg-gray-200 text-white dark:text-gray-900 py-3 rounded-full font-semibold hover:bg-gray-600 dark:hover:bg-gray-300 transition-colors duration-300"
              >
                Contact Sales
              </Link>
            </div>
